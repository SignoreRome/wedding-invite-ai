...
- Сводка считает гостей, которые отметили присутствие, включая `+1` у присутствующих гостей, но не удваивает пару, если для нее уже есть отдельная присутствующая строка.
