...
Для ручной настройки параметров можно изменить строку `game_settings.id = 1` через Prisma Studio или SQL. `endless_speed_multiplier` должен быть больше `0` и не больше `3`.
